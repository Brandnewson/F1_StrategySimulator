...
\hline 
Final Report & PDF file & Uploaded to Minerva (20/04/26) \\ 
\hline 
Link to online code repository & URL & Sent to supervisor and assessor (25/04/26) \\ 
\hline 
\end{tabular} 
\end{table}
...
\noindent The candidate understands that failure to attribute material which is obtained from another source may be considered as plagiarism.
