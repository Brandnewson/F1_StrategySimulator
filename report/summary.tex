...
Scaling to five agents reverses this result completely. Cooperative incentive at any alpha value degrades joint performance by up to 31 per cent. Curriculum scheduling recovers 69 per cent of this loss by separating two previously conflated failure modes. One is a training-order problem that curriculum solves. The other is a credit assignment problem that requires architectural solutions.
